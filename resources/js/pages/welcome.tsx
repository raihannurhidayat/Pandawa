...
const App = ({ issuesByStatus, issueStatistics }: LandingProps) => {
    ...
    const statusData = Object.entries(issuesByStatus || {});
    const totalIssues = statusData.reduce((sum, [, count]) => sum + (count || 0), 0);
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-gradient-to-br font-poppins from-slate-50 via-blue-50 to-indigo-100 relative overflow-visible">
                ...
                <div id="Beranda" className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-18 pb-16 sm:pb-32">
                ...
                <div className="relative -mt- mb-10 md:-mt-10">
                    ...
                    <section className="relative bg-gradient-to-r from-green-500 to-green-500 shadow-lg transform rotate-1 overflow-hidden">
                ...
                <section id='Statistik' className="relative bg-gradient-to-br from-green-400 via-green-500 to-lime-400 py-12 sm:py-16 rounded-3xl mx-8 mt-20">
                            ...
                            <div className="group">
                                <div className="relative bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 h-60 flex flex-col justify-between transition-all duration-300 hover:scale-[1.02] hover:shadow-lg">
                                    ...
                                    <div className="text-center text-white space-y-2">
                                        <p className="text-4xl font-black">{totalIssues.toLocaleString()}</p>
                                        <p className="text-lg font-bold">Total Laporan</p>
                                        <p className="text-sm opacity-90">Seluruh laporan masuk</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            {issueStatistics && (
                                <div className="group">
                                    <div className="relative bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-2xl p-6 h-60 flex flex-col justify-between transition-all duration-300 hover:scale-[1.02] hover:shadow-lg">
                                        ...
                                        <div className="text-center text-white space-y-2">
                                            <p className="text-4xl font-black">{issueStatistics.active.toLocaleString()}</p>
                                            <p className="text-lg font-bold">Laporan Aktif</p>
                                            <p className="text-sm opacity-90">Sedang diproses</p>
                                        </div>
                                    </div>
                                </div>
                            )}
                            ...
                            {issueStatistics && (
                                <div className="group">
                                    <div className="relative bg-gradient-to-br from-green-500 to-green-600 rounded-2xl p-6 h-60 flex flex-col justify-between transition-all duration-300 hover:scale-[1.02] hover:shadow-lg">
                                        ...
                                        <div className="text-center text-white space-y-2">
                                            <p className="text-4xl font-black">{issueStatistics.resolved.toLocaleString()}</p>
                                            <p className="text-lg font-bold">Laporan Selesai</p>
                                            <p className="text-sm opacity-90">Berhasil diselesaikan</p>
                                        </div>
                                    </div>
                                </div>
                            )}
                                    ...
                                    <div className="relative bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl p-6 h-60 flex flex-col justify-between transition-all duration-300 hover:scale-[1.02] hover:shadow-lg">
                                        ...
                                        <div className="text-center text-white space-y-2">
                                            <p className="text-4xl font-black">
                                                {totalIssues > 0 ? Math.round((issueStatistics.resolved / totalIssues) * 100) : 0}%
                                            </p>
                                            <p className="text-lg font-bold">Tingkat Penyelesaian</p>
                                            <p className="text-sm opacity-90">Persentase selesai</p>
                                        </div>
                                    </div>
                                </div>
                            )}
